...
- **Kinds of change (count):** distinct *kinds* (not files, not lines) — see **`development-process.md`** mode #3 *PR sizing* and [**`20_efficient-pr-shipping.mdc`**](../../../../rules/20_efficient-pr-shipping.mdc) § *Keep PRs small and focused*.
