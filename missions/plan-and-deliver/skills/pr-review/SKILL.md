...
Before applying any code, plan, or GitHub changes, open the **disposition gate** in Step **4** (`mission_control_present_structured_choice` or **AskQuestion** with the **contextual** option set in Step **4** § *Build disposition options*). **Do not** duplicate the gate in prose.
